...
namespace CPMS.Report.Rendering.Adapters
{
    public class ReportService
    {
        ...
        public File GetEventBreachesReportFile(DateTime fromDate, DateTime toDate,
            Format format, int hospitalId, string specialtyCode, int clinicianId, Granularity granularity, string pathwayType)
        {
            ...
            switch (granularity)
            {
                case Granularity.Specialty:
                {
                    ...
                    outputFileName = "MonthlyPerformanceBySpecialty";
                    break;
                }
                case Granularity.Clinician:
                {
                    ...
                    outputFileName = "MonthlyPerformanceByClinician";
                    break;
                }
                case Granularity.Hospital:
                {
                    ...
                    outputFileName = "MonthlyPerformanceByHospital";
                    break;
                }
            ...
            var periodBreachesReportData = _reportPresentationService.GetEventBreachesReport(fromDate, toDate, hospitalId,
                specialtyCode, clinicianId, granularity, pathwayType);
        ...
        public File GetFuturePeriodBreachesReportFile(int weeksToBreach,
            Format format, Layout layout, int hospitalId, string specialtyCode, int clinicianId, Granularity granularity, string pathwayType)
        {
            string outputFileName;
            string templateFileName;
        ...
        public File GetActivePeriodsDistributionReportFile(Format format, Layout layout, int hospitalId, string specialtyCode, int clinicianId, Granularity granularity, string pathwayType)
        {
            string outputFileName;
            string templateFileName;
            ...
            var activePeriodsDistributionReportData = _reportPresentationService.GetActivePeriodsDistributionReport(hospitalId, specialtyCode, clinicianId, granularity, pathwayType);
