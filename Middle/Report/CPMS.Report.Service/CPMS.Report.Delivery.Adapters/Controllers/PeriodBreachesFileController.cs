...
namespace CPMS.Report.Delivery.Adapters.Controllers
{
    public class PeriodBreachesFileController : ApiController
    {
        ...
        public HttpResponseMessage GetPeriodBreachesReportFile(DateTime fromDate, DateTime toDate,
        ...
        {
            var reportFile = _reportService.GetPeriodBreachesReportFile(fromDate, toDate, format, hospitalId, specialtyCode,
