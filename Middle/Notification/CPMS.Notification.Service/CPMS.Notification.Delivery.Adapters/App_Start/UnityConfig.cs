...
namespace CPMS.Notification.Delivery.Adapters.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IRuleViolationRepository, RuleViolationRepository>();
            ...
            container.RegisterType<IMapper<RuleViolationInfo, RuleViolationViewModel>, Mapper<RuleViolationInfo, RuleViolationViewModel>>();
