...
namespace CPMS.Patient.Delivery.Adapters.Controllers
{
    ...
    public class EventBreachesController : ApiController
    {
        ...
        public EventBreachesViewModel GetEventBreaches([ModelBinder(typeof(RoleDataModelBinder))]RoleData role, int daysToBreach, string pathwayType = null, int? index = null, int? pageCount = null, string patientNHSNumber = null, string patientName = null, string eventCode = null, string hospital = null, string specialty = null, string clinician = null, string periodType = null, int? advancementOrDelay = null, string orderBy = null, string orderDirection = null)
        {
