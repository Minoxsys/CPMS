...
namespace CPMS.Patient.Delivery.Adapters.Controllers
{
    ...
    public class PatientsController : ApiController
    {
        ...
        public PatientsViewModel GetPatientsOnPathway([ModelBinder(typeof(RoleDataModelBinder))]RoleData role, int? index = null, int? pageCount = null, string patientName = null, string hospital = null, string ppiNumber = null, string nhsNumber = null, string periodType = null, string orderBy = null, string orderDirection = null)
        {
