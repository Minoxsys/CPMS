...
namespace CPMS.Patient.Delivery.Adapters.Controllers
{
    public class PeriodEventsController : ApiController
    {
        ...
        public PeriodEventsViewModel GetPeriodEvents([ModelBinder(typeof(RoleDataModelBinder))]RoleData role, int periodId, int? index = null, int? pageCount = null, string eventDescription = null, string specialty = null, int? targetYear = null, int? actualYear = null, int? breaches = null, string periodType = null, string orderBy = null, string orderDirection = null)
        {
