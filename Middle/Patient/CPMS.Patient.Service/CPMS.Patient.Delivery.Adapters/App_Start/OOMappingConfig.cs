    ...
    public static class OOMappingConfig
    {
        public static void RegisterMappings()
        {
            ...
            Mapper.CreateMap<PeriodsAndEventsBreachesCountInfo, PeriodsAndEventsBreachesCountViewModel>()
                .ForMember(dest=>dest.EventsBreachesCountViewModelForCardiac, m=>m.MapFrom(src=>src.EventsBreachesCountInfoForCardiac))
                .ForMember(dest => dest.EventsBreachesCountViewModelForDiabetes, m => m.MapFrom(src => src.EventsBreachesCountInfoForDiabetes))
                .ForMember(dest => dest.EventsBreachesCountViewModelForFrailElderly, m => m.MapFrom(src => src.EventsBreachesCountInfoForFrailElderly))
