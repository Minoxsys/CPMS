		...
		return {
			...
			link: function(scope, elem, attrs) {
				...
				function updateChart(data) {
					...
					addExtraInfo(pathwayChartData, periodChartData, data.pathway);
				...
				function addExtraInfo(pathwayData, periodData, pathway) {
					cvs.text({
						xPercent: 2,
						x: -11,
						yPercent: periodLineYPercent,
						y: -50,
						color: colors.periodBorder,
						str: pathway.type + " Pathway " + pathway.node.name ,/*pathwayData.selectedPeriod.periodData.name*/
						fontSize: 22,
					});
