...
function BreachesLogController($scope, $timeout, dataProvider, authProvider) {
	this.$scope = $scope;
...
BreachesLogController.$inject = ["$scope", "$timeout", "BreachesLogDataProvider", "AuthorizationProvider"];
