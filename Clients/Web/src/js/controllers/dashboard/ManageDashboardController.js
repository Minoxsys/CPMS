...
function ManageDashboardController(dashboardSettings) {
	...
	this.widgetNames = {
		breachesChart: "Current Performance - Milestone Events",
		breachesChart2: "Current Performance - Milestone Events",
		// periodBreachesChart: "Period breaches",
		breachedCompletedEventsChart: "Performance Completed Events - Past 12 months",
		breachedEventMilestonesChart: "Current Events",
		activityLog: "Activity log",
		breachesLog: "Post Milestone log"
	};
...
ManageDashboardController.prototype = {
    ...
    console.log(this.selectedAvailableWidget);
