...
function MenuController($scope, $timeout, MenuDataProvider, userDataProvider) {
	...
	function handleUserPermissions(user) {
		...
		if (!rights.EventBreaches) {
			removeMenuItem(tree.categories.breaches._item.children, "eventBreaches1");
			removeMenuItem(tree.categories.breaches._item.children, "eventBreaches2");
			removeMenuItem(tree.categories.breaches._item.children, "eventBreaches3");
		}
